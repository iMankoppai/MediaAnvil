...
1. 从左侧导航打开“音频标签编辑”，选择 MP3、FLAC、M4A、OGG 或 Opus 音频。
...
1. 从左侧导航打开“音频格式转换”，选择一个或多个 MP3、WAV、FLAC、M4A、AAC 或 OGG 文件。
...
1. 从左侧导航打开“图片格式转换”，选择一张或多张 JPG、JPEG、PNG、WebP 或 BMP 图片。
